...
def run_swiglu(
    ...
    from cs336_basics.modules import SwiGLU, get_compatible_dff
...
def run_multihead_self_attention(
    ...
    causal_multihead_self_attention = CausalMultiheadSelfAttention(
        d_model=d_model,
        num_heads=num_heads,
    ...
    causal_multihead_self_attention.load_state_dict({
...
def run_transformer_block(
    ...
    transformer_block.load_state_dict({
        "pre_norm1.g": weights["ln1.weight"],
        ...
        "pre_norm2.g": weights["ln2.weight"],
...
def run_get_batch(
    ...
    """
    from cs336_basics.io import data_loader
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.modules import softmax_stable
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.modules import cross_entropy_stable
    return cross_entropy_stable(logits=inputs, targets=targets)
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.modules import learning_rate_cosine_schedule
    return learning_rate_cosine_schedule(t=it, lr_max=max_learning_rate, lr_min=min_learning_rate, warmup_iters=warmup_iters, total_iters=cosine_cycle_iters)
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.io import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.io import load_checkpoint
